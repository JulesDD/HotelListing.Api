...
public interface IBookingService
{
    ...
    Task<Result<PagedResult<GetBookingDto>>> GetHotelBookingsAsync(int hotelId, PaginationParameters paginationParameters, BookingFilteringParameters bookingFilteringParameters);
    Task<Result<PagedResult<GetBookingDto>>> GetUserBookingsForHotelsAsync(int hotelId, PaginationParameters paginationParameters,
